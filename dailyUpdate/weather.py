...
jhb1_responses = openmeteo.weather_api(url, params=jhb1_params)
jhb1_response = jhb1_responses[0]

cpt_responses = openmeteo.weather_api(url, params=cpt_params)
cpt_response = cpt_responses[0]


def hourly_weather(hour, campus):
    if campus == "Durban":
        hourly = dbn_response.Hourly()
    elif campus == "Cape Town":
        hourly = cpt_response.Hourly()
    elif campus == "Johannesburg":
        hourly = jhb1_response.Hourly()
...
if __name__ == '__main__':
    print(hourly_weather(8, "Durban")[0])
    print(hourly_weather(12, "Durban")[0])
    print(hourly_weather(16, "Durban")[0])
    print(hourly_weather(16,"Durban")[1])
